...
#[command(name = "opensin-cli", version, about = "OpenSIN Code CLI")]
pub struct Cli {
    #[arg(long, default_value = "opensin-ai-opus-4-6")]
    pub model: String,
...
mod tests {
    ...
    fn parses_requested_flags() {
        ...
        assert_eq!(cli.model, "opensin-ai-haiku-4-5-20251213");
